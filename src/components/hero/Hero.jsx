...
//       <div className="absolute bottom-0 sm:w-[40rem] sm:ml-80">
//         {/* <img src="hero.png" alt="" /> */}
//         {/* <img src="soya.png" alt="" className=""/> */}
//         <img src={myphoto} className="sm:mt-20 hidden sm:flex" />
//         <img src={mypho} className="sm:mt-20 sm:hidden h-[35rem]" />
//       </div>
//       <motion.div
...
const Hero = () => {
  return (
    <div className="h-screen w-full relative flex flex-col justify-center items-center overflow-hidden text-center">
      {/* ==== 3D Background ==== */}
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        >
          <h1 className="text-pink-300">Hey There,</h1>
          <h1 className="mt-2">I'm Md Absar,</h1>
        </motion.div>

        {/* Typewriter Effect */}
        <div className="flex justify-center items-center gap-2 sm:gap-3 text-xl sm:text-2xl mt-2 text-violet-200">
          <motion.h1
            initial={{ x: -100, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 1 }}
        ...
        >
          <motion.a
            ...
            target="_blank"
            download="MyResume.pdf"
            className="bg-blue-500 text-white px-5 py-2 rounded-lg hover:bg-blue-700 hover:scale-105 transition duration-300 ease-in-out"
          >
            My Resume
          </motion.a>
          <motion.a
